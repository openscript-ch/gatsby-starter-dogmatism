...
type MdxFieldsFieldSelector = {
  ...
  readonly translations: InputMaybe<MdxFieldsTranslationsFieldSelector>;
};
...
type MdxFieldsSortInput = {
  ...
  readonly translations: InputMaybe<MdxFieldsTranslationsSortInput>;
};
...
type MdxFieldsTranslationsFieldSelector = {
  readonly locale: InputMaybe<FieldSelectorEnum>;
  readonly path: InputMaybe<FieldSelectorEnum>;
};
...
type MdxFieldsTranslationsSortInput = {
  readonly locale: InputMaybe<SortOrderEnum>;
  readonly path: InputMaybe<SortOrderEnum>;
};
...
type GenericPagesQueryVariables = Exact<{
  id: Scalars['String'];
}>;
...
type IndexPageQuery = { readonly mdx: { readonly body: string | null } | null };
