...
type FileFieldsEnum =
  ...
  | 'childMdx.excerpt'
  | 'childMdx.fields.filename'
  | 'childMdx.fields.kind'
  | 'childMdx.fields.locale'
  | 'childMdx.fields.path'
  | 'childMdx.fields.pathPrefix'
  | 'childMdx.fields.slug'
  | 'childMdx.fields.translations'
  | 'childMdx.fields.translations.locale'
  | 'childMdx.fields.translations.path'
  ...
  | 'childrenMdx.excerpt'
  | 'childrenMdx.fields.filename'
  | 'childrenMdx.fields.kind'
  | 'childrenMdx.fields.locale'
  | 'childrenMdx.fields.path'
  | 'childrenMdx.fields.pathPrefix'
  | 'childrenMdx.fields.slug'
  | 'childrenMdx.fields.translations'
  | 'childrenMdx.fields.translations.locale'
  | 'childrenMdx.fields.translations.path'
...
type MdxFields = {
  ...
  readonly slug: Maybe<Scalars['String']>;
  readonly translations: Maybe<ReadonlyArray<Maybe<MdxFieldsTranslations>>>;
};
...
type MdxFieldsFilterInput = {
  ...
  readonly translations: InputMaybe<MdxFieldsTranslationsFilterListInput>;
};

type MdxFieldsTranslations = {
  readonly locale: Maybe<Scalars['String']>;
  readonly path: Maybe<Scalars['String']>;
};

type MdxFieldsTranslationsFilterInput = {
  readonly locale: InputMaybe<StringQueryOperatorInput>;
  readonly path: InputMaybe<StringQueryOperatorInput>;
};

type MdxFieldsTranslationsFilterListInput = {
  readonly elemMatch: InputMaybe<MdxFieldsTranslationsFilterInput>;
};
...
type DefaultLayoutQuery = { readonly site: { readonly siteMetadata: { readonly author: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly title: string | null, readonly version: string | null, readonly project: string | null } | null } | null };
...
type IndexPageQuery = { readonly slogans: { readonly body: string } | null };

type GenericPageQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type GenericPageQuery = { readonly mdx: { readonly id: string, readonly body: string } | null };
